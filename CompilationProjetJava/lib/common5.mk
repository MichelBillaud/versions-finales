...
PANDOC_PDF = pandoc -t latex --pdf-engine=xelatex -N --toc --self-contained -V lang=fr --variable=geometry:a4paper,inner=1.5cm,outer=1cm,tmargin=2cm,bmargin=3cm  -V documentclass:extarticle
